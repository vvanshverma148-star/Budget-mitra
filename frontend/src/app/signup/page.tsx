...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-background text-on-background">
      ...
      {/* 3D perspective signup card */}
      <div 
        className="relative z-10 w-full max-w-md p-6 mt-12 mb-12"
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-headline-lg font-bold text-primary mb-1.5">Create Account</h1>
            <p className="text-on-surface-variant text-xs font-semibold">Join Budget Mitra to save and track prices</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 text-left">
            ...
            <div className="space-y-2 relative group">
              <label className="text-[10px] font-bold text-primary/75 uppercase tracking-wider ml-1">Full Name</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <User className="w-4.5 h-4.5 text-on-surface-variant/60 group-focus-within:text-primary transition-colors" />
                </div>
                <input 
                  type="text" 
                  required
            ...
            <div className="space-y-2 relative group">
              <label className="text-[10px] font-bold text-primary/75 uppercase tracking-wider ml-1">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            ...
            <div className="space-y-2 relative group">
              <label className="text-[10px] font-bold text-primary/75 uppercase tracking-wider ml-1">Confirm Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <Lock className="w-4.5 h-4.5 text-on-surface-variant/60 group-focus-within:text-primary transition-colors" />
                </div>
          ...
          <div className="mt-8 text-center text-xs text-on-surface-variant/80">
            Already have an account? <button onClick={() => router.push('/login')} className="font-bold text-surface-tint hover:text-primary">Sign in</button>
          </div>
        </div>
      </div>
    </div>
